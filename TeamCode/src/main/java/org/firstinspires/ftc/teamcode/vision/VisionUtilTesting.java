...
public class VisionUtilTesting extends OpenCvPipeline {
    ...
    public Mat processFrame(Mat input) {
        processedMat = visionUtil.prepareFrame(input);
        processedMat.copyTo(displayMat);
        ...
        contours  = visionUtil.getFilteredContours(contours, 15, 1000);

        Imgproc.drawContours(displayMat, contours, -1, visionUtil.magenta, 1);
